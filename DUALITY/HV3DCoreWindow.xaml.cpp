...
#if __has_include("HV3DCoreWindow.g.cpp")
#include "HV3DCoreWindow.g.cpp"
#endif
...
{
    HV3DCoreWindow::HV3DCoreWindow()
    {
        InitializeComponent();

    }

    void HV3DCoreWindow::Activated(IInspectable sender, WindowActivatedEventArgs args)
    {
        ...
        oAppFrame = make<HV3DCoreFrame>();
        oAppFrame.Navigate(xaml_typename<DUALITY::HV3DCoreUI>());
