#include "pch.h"
#include "HV4DPeregrineX12.h"
#if __has_include("HV4DPeregrineX12.g.cpp")
#include "HV4DPeregrineX12.g.cpp"
#endif
...
using namespace winrt::HV4DDUALITY::HV4DTensors;

namespace winrt::PeregrineX12::implementation
{
	void HV4DPeregrineX12::HV4DOnInit(Windows::Foundation::IInspectable panel)
	{
	...
	void HV4DPeregrineX12::HV4DOnUpdate()
	{
	...
	void HV4DPeregrineX12::HV4DOnRender()
	{
		HRESULT hr = S_OK;
	...
	void HV4DPeregrineX12::HV4DOnDestroy()
	{
		HV4DWaitForPreviousFrame();
	...
	void HV4DPeregrineX12::HV4DLoadPipeline()
	{
		HRESULT hr = S_OK;
	...
	IVector<HV4DDUALITY::HV4DTensors::HV4DTriangle> oInputBuffer{};
	...
	void HV4DPeregrineX12::HV4DLoadAssets()
	{
		...
		HV4DLoaders::HV4DObjLoader oLoader{};		
	...
	void HV4DPeregrineX12::HV4DPopulateCommandList()
	{
		HRESULT hr = S_OK;
	...
	void HV4DPeregrineX12::HV4DWaitForPreviousFrame()
	{
		HRESULT hr = S_OK;
