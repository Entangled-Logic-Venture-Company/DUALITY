...
#include "HV4DPeregrineX12.g.h"

namespace winrt::PeregrineX12::implementation
{
    struct HV4DPeregrineX12 : HV4DPeregrineX12T<HV4DPeregrineX12>
    {
    public:
        HV4DPeregrineX12() = default;

        virtual void HV4DOnInit(winrt::Windows::Foundation::IInspectable panel);

        virtual void HV4DOnUpdate();

        virtual void HV4DOnRender();

        virtual void HV4DOnDestroy();
...
{
    struct HV4DPeregrineX12 : HV4DPeregrineX12T<HV4DPeregrineX12, implementation::HV4DPeregrineX12>
    {
