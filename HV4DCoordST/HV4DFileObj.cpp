...
#if __has_include("HV4DFileObj.g.cpp")
#include "HV4DFileObj.g.cpp"
#endif
...
{
    IVector<HV4DTriangle> HV4DFileObj::LoadMeshFromFile(hstring file)
    {
        string line;
    ...
    void HV4DFileObj::ExtractVertexFromLine(wstring l)
    {
        float xval = 0.0f;
        float yval = 0.0f;
        float zval = 0.0f;
    ...
    void HV4DFileObj::ExtractTextCoordFromLine(wstring l)
    {
        float uval = 0.0f;
        float vval = 0.0f;
    ...
    void HV4DFileObj::ExtractVertexNormalFromLine(wstring l)
    {
        float aval = 0.0f;
        float bval = 0.0f;
        float cval = 0.0f;
    ...
    void HV4DFileObj::MakeFaces(wstring l)
    {
        size_t pos1{ 0 };
        size_t pos2{ 0 };
        size_t pos3{ 0 };
    ...
    IVector<hstring> HV4DFileObj::ReadFromObjAsync(wstring file)
    {
    ...
    void HV4DFileObj::CreateDebugFileAsync(std::wofstream** buffer, wstring file)
    {
    ...
    void HV4DFileObj::WriteDebugFileAsync(wofstream** out, wstring line)
    {
