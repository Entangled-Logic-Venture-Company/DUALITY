...
namespace winrt::KernelsST::implementation
{
    ...
    void winrt::KernelsST::implementation::ContainerUI::Page_Loaded(winrt::Windows::Foundation::IInspectable const& sender, winrt::Microsoft::UI::Xaml::RoutedEventArgs const& e)
    {
        int32_t ret = 0;
